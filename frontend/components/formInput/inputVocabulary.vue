...
export default {
  ...
  mounted() {
    ...
    show_image_after_input({
      idImg: TAG_INPUT_IMAGE,
      idInput: ".inputVocabulary > form > #input-image",
    });

    beforePaste(TAG_INPUT_WORD)
    beforePaste(TAG_INPUT_PRONOUNCE)
    beforePaste(TAG_INPUT_TRANSLATE)
    beforePaste(TAG_INPUT_EXAMPLE)
